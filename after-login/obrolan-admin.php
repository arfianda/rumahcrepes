    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item active">
                <a class="nav-link" href="daftar-pemesan">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-2 text-gray-800">Belum Diverifikasi</h1>

                    <?php 
                        include '../koneksi.php';
                        $data = mysqli_query($koneksi,"select * from wangsaf");
                    ...
                    <div class="card shadow mb-4">
                        ...
                        <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                            <h6 class="m-0 font-weight-bold text-primary"><i class="fas fa-fw fa-user"></i>
                                <?php echo $d['nama']; ?></h6>
                            <div class="dropdown no-arrow">
                                ...
                                <div class="dropdown-menu dropdown-menu-right shadow animated--fade-in"
                                    ...
                                    <a class="dropdown-item" href="wangsaf?nama=<?php echo $d['nama']; ?>">Balas</a>
                        ...
                        <div style="text-align: justify;" class="card-body">
                            ...
                            <div style="float: right;">
                                <i class="fas fa-fw fa-clock"></i> <?php echo $d['waktu']; ?>
                            </div>
                        </div>
                    </div>
                    <?php 
