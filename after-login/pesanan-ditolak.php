        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-2 text-gray-800"><i style="color: #000;" class="fas fa-fw fa-exclamation-triangle"></i> Pesanan Ditolak
                    </h1>
                    <p class="mb-4">Berikut ini adalah data yang berisi daftar pesanan yang ditolak.</p>
