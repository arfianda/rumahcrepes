...
if ($mysqli)
    ...
    $pesan = 'Pesanan Catering <strong> Rumah Crepes</strong> oleh <strong>anda</strong> dengan nama <strong>'.$nama_pemesan.'</strong> dan menggunakan email <strong>' . $email_pemesan . '</strong> telah <strong>ditolak</strong>.
    <br>
    <br>
    ...
    if ($send) {
        ...
        if ($data) {
            ...
            $aidi = $d['id'];
            $sql = "UPDATE daftar_pemesan SET statuz='Ditolak' WHERE id='$aidi'";
